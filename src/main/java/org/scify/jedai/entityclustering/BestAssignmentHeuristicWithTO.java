 ...
 * @author Manos
 */
public class BestAssignmentHeuristicWithTO extends AbstractCcerEntityClustering {
    ...
    public BestAssignmentHeuristicWithTO() {
        this(0.5f);
    }

    public BestAssignmentHeuristicWithTO(float simTh) {
        super(simTh);
    }
    ...
    private void execute() {
        ...
        for (int i = 0; i < numMoves; i++) {
            ...
            if ((time3-time2)>1000*timeout) break;
