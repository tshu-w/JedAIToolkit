 ...
 * @author G.A.P. II
 */
public class MarkovClusteringCCER extends AbstractEntityClustering {
    ...
    public MarkovClusteringCCER() {
        this(0.49f, 0.00001f, 2, 0.5f);
    }

    public MarkovClusteringCCER(float ct, float mst, int scl, float st) {
        super(st);
        clusterThreshold = ct;
        if (ct<st-0.01) clusterThreshold=st-0.01f;
