 ...
 * @author G.A.P. II
 */
public class CenterClusteringCCERsingleEdge extends AbstractEntityClustering {

    public CenterClusteringCCERsingleEdge() {
        this(0.5f);
    }

    public CenterClusteringCCERsingleEdge(float simTh) {
        super(simTh);
    }
    ...
    public EquivalenceCluster[] getDuplicates(SimilarityPairs simPairs) {
        ...
        while (!SEqueue.isEmpty()) {
            ...
            } //TODO DON"T ALLOW >1 PAIRS FOR EACH ENTITY PROFILE
